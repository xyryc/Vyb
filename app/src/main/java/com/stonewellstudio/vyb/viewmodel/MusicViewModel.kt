package com.stonewellstudio.vyb.viewmodel

import android.app.Application
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.viewModelScope
import com.stonewellstudio.vyb.data.*
...
class MusicViewModel(application: Application) : AndroidViewModel(application) {
        ...
        viewModelScope.launch {
            try {
                ...
                if (coverUrl.contains("unsplash.com")) {
                    try {
                        val onlineArtUrl = com.stonewellstudio.vyb.player.AlbumArtService.fetchAlbumArt(artist, title)
    ...
    private fun prepopulateDatabaseIfNeeded() {
        viewModelScope.launch {
            // Delete any legacy demo tracks if present so app starts completely clean
    ...
    fun selectOutputDevice(device: com.stonewellstudio.vyb.player.AudioDeviceWrapper) {
    ...
    fun checkAndDownloadAlbumArt(track: TrackEntity) {
        ...
        if (isPlaceholder) {
            viewModelScope.launch {
                try {
                    val onlineArtUrl = com.stonewellstudio.vyb.player.AlbumArtService.fetchAlbumArt(track.artist, track.title)
                    if (onlineArtUrl != null) {
