package com.stonewellstudio.vyb.ui.theme
...
private fun getDarkColorScheme(primaryColor: Color) =
  darkColorScheme(
    ...
    secondary = VybGrey,
    tertiary = VybDarkGreen,
    background = VybBlack,
    surface = VybSurface,
    onPrimary = VybBlack,
    onSecondary = VybWhite,
    onTertiary = VybWhite,
    onBackground = VybWhite,
    onSurface = VybWhite,
    surfaceVariant = VybSurfaceVariant,
    onSurfaceVariant = VybGrey
  )
